...
footer.append(`<div class="footer">
    <div id="footerNav" class="container-fluid">
        <div id="" class="row">
            <div class="col-lg-3 col-md-12 col-sm-12 footerLogo">
                <a href=""><img class="footer-logo" src="../../IMG/Vaquaria.png" alt=""></a>
            </div>
            <div class="col-lg-9 col-md-12 col-sm-12 footerNav-content">
                <div class="footerNav-content-1">
                    <p class="footerNav-title"><a href=""></a>Sản Phẩm</p>
                    <div class="footerNav-menu">
                        <ul class="footerNav-list1">
